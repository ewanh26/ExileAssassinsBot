...
const cmd = {
    ...
    exec: (message, d, args) => {
        if (message.member?.roles.cache.some(r => r.id === "845381923941253120")) {
            const unban_emb = new d.MessageEmbed()
                .setColor("#ffffff")
                .setTitle("You... are the last hope of the Light? I have taken entire worlds. You are not worthy to face me.")
                .setImage("http://pa1.narvii.com/6226/6c8a7cdfd03344985fe8268dc769cad823678c21_00.gif");
            if (message.member?.roles.cache.some(r => r.id === "845381923941253120")) {
